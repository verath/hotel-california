 ...
 * <ul>
 *   <li>{@link Classes.impl.RoomImpl#getFloor <em>Floor</em>}</li>
 *   <li>{@link Classes.impl.RoomImpl#getRoomNumber <em>Room Number</em>}</li>
 *   <li>{@link Classes.impl.RoomImpl#isOperational <em>Is Operational</em>}</li>
 *   <li>{@link Classes.impl.RoomImpl#isCleaned <em>Is Cleaned</em>}</li>
 *   <li>{@link Classes.impl.RoomImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link Classes.impl.RoomImpl#getPhotos <em>Photos</em>}</li>
 *   <li>{@link Classes.impl.RoomImpl#getAllowedKeyCards <em>Allowed Key Cards</em>}</li>
 *   <li>{@link Classes.impl.RoomImpl#getRoomType <em>Room Type</em>}</li>
 *   <li>{@link Classes.impl.RoomImpl#getRoom <em>Room</em>}</li>
 *   <li>{@link Classes.impl.RoomImpl#getDisabilityApprovals <em>Disability Approvals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoomImpl extends MinimalEObjectImpl.Container implements Room {
	...
	public void setFloor(int newFloor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.ROOM__FLOOR, oldFloor, floor));
	}
	...
	public void setIsOperational(boolean newIsOperational) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.ROOM__IS_OPERATIONAL, oldIsOperational, isOperational));
	}
	...
	public void setIsCleaned(boolean newIsCleaned) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.ROOM__IS_CLEANED, oldIsCleaned, isCleaned));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.ROOM__DESCRIPTION, oldDescription, description));
	}
	...
	public EList<String> getPhotos() {
		if (photos == null) {
			photos = new EDataTypeUniqueEList<String>(String.class, this, ClassesPackage.ROOM__PHOTOS);
		}
		return photos;
	}
	...
	public EList<KeyCard> getAllowedKeyCards() {
		if (allowedKeyCards == null) {
			allowedKeyCards = new EObjectResolvingEList<KeyCard>(KeyCard.class, this, ClassesPackage.ROOM__ALLOWED_KEY_CARDS);
		}
	...
	public Room getRoom() {
		if (room != null && room.eIsProxy()) {
			...
			if (room != oldRoom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.ROOM__ROOM, oldRoom, room));
			}
		}
		return room;
	}
	...
	public void setRoom(Room newRoom) {
		...
		room = newRoom;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.ROOM__ROOM, oldRoom, room));
	}
	...
	public void setDisabilityApprovals(DisabilityApproval newDisabilityApprovals) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.ROOM__DISABILITY_APPROVALS, oldDisabilityApprovals, disabilityApprovals));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.ROOM__FLOOR:
				return getFloor();
			case ClassesPackage.ROOM__ROOM_NUMBER:
				return getRoomNumber();
			case ClassesPackage.ROOM__IS_OPERATIONAL:
				return isOperational();
			case ClassesPackage.ROOM__IS_CLEANED:
				return isCleaned();
			case ClassesPackage.ROOM__DESCRIPTION:
				return getDescription();
			case ClassesPackage.ROOM__PHOTOS:
				return getPhotos();
			case ClassesPackage.ROOM__ALLOWED_KEY_CARDS:
				return getAllowedKeyCards();
			case ClassesPackage.ROOM__ROOM_TYPE:
				if (resolve) return getRoomType();
				return basicGetRoomType();
			case ClassesPackage.ROOM__ROOM:
				if (resolve) return getRoom();
				return basicGetRoom();
			case ClassesPackage.ROOM__DISABILITY_APPROVALS:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ClassesPackage.ROOM___REGISTER_KEY_CARD__KEYCARD:
				registerKeyCard((KeyCard)arguments.get(0));
				return null;
			case ClassesPackage.ROOM___UNREGISTER_KEY_CARD__KEYCARD:
				unregisterKeyCard((KeyCard)arguments.get(0));
				return null;
			case ClassesPackage.ROOM___UNREGISTER_KEY_CARDS:
				unregisterKeyCards();
				return null;
		}
