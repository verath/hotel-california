 ...
 * <ul>
 *   <li>{@link Classes.impl.ConferenceRoomImpl#getNumberOfSeats <em>Number Of Seats</em>}</li>
 *   <li>{@link Classes.impl.ConferenceRoomImpl#getEquipment <em>Equipment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConferenceRoomImpl extends RoomImpl implements ConferenceRoom {
	...
	protected EClass eStaticClass() {
		return ClassesPackage.Literals.CONFERENCE_ROOM;
	}
	...
	public void setNumberOfSeats(int newNumberOfSeats) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.CONFERENCE_ROOM__NUMBER_OF_SEATS, oldNumberOfSeats, numberOfSeats));
	}
	...
	public EList<String> getEquipment() {
		if (equipment == null) {
			equipment = new EDataTypeUniqueEList<String>(String.class, this, ClassesPackage.CONFERENCE_ROOM__EQUIPMENT);
		}
		return equipment;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.CONFERENCE_ROOM__NUMBER_OF_SEATS:
				return getNumberOfSeats();
			case ClassesPackage.CONFERENCE_ROOM__EQUIPMENT:
				return getEquipment();
		}
