 ...
 * <ul>
 *   <li>{@link Classes.impl.BillManagerImplImpl#getBillDataService <em>Bill Data Service</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BillManagerImplImpl extends MinimalEObjectImpl.Container implements BillManagerImpl {
	...
	protected EClass eStaticClass() {
		return ClassesPackage.Literals.BILL_MANAGER_IMPL;
	}
		...
		if (billDataService != null && billDataService.eIsProxy()) {
			...
			if (billDataService != oldBillDataService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.BILL_MANAGER_IMPL__BILL_DATA_SERVICE, oldBillDataService, billDataService));
			}
		}
	...
	public void setBillDataService(BillDataService newBillDataService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BILL_MANAGER_IMPL__BILL_DATA_SERVICE, oldBillDataService, billDataService));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.BILL_MANAGER_IMPL__BILL_DATA_SERVICE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ClassesPackage.BILL_MANAGER_IMPL___GET_BILL__INT:
				return getBill((Integer)arguments.get(0));
			case ClassesPackage.BILL_MANAGER_IMPL___GET_BOOKING_BILL__BOOKING:
				getBookingBill((Booking)arguments.get(0));
				return null;
			case ClassesPackage.BILL_MANAGER_IMPL___BILL_ITEM__BILL_INT_INT:
				billItem((Bill)arguments.get(0), (Integer)arguments.get(1), (Integer)arguments.get(2));
				return null;
			case ClassesPackage.BILL_MANAGER_IMPL___GET_ALL_SERVICES:
				getAllServices();
				return null;
			case ClassesPackage.BILL_MANAGER_IMPL___ADD_SUB_BILL__BILL_BILL:
				addSubBill((Bill)arguments.get(0), (Bill)arguments.get(1));
				return null;
			case ClassesPackage.BILL_MANAGER_IMPL___APPLY_DISCOUNT__DISCOUNT_BILL:
				applyDiscount((Discount)arguments.get(0), (Bill)arguments.get(1));
				return null;
			case ClassesPackage.BILL_MANAGER_IMPL___PUBLISH_BILL__BILL:
				publishBill((Bill)arguments.get(0));
				return null;
			case ClassesPackage.BILL_MANAGER_IMPL___MARK_BILL_AS_PAID__BILL_BOOLEAN:
