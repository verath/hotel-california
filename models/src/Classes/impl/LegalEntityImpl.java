 ...
 * <ul>
 *   <li>{@link Classes.impl.LegalEntityImpl#getPhone <em>Phone</em>}</li>
 *   <li>{@link Classes.impl.LegalEntityImpl#getEmail <em>Email</em>}</li>
 *   <li>{@link Classes.impl.LegalEntityImpl#getCreditCardInformation <em>Credit Card Information</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LegalEntityImpl extends MinimalEObjectImpl.Container implements LegalEntity {
	...
	protected EClass eStaticClass() {
		return ClassesPackage.Literals.LEGAL_ENTITY;
	}
	...
	public void setPhone(String newPhone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.LEGAL_ENTITY__PHONE, oldPhone, phone));
	}
	...
	public void setEmail(String newEmail) {
		...
		email = newEmail;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.LEGAL_ENTITY__EMAIL, oldEmail, email));
	}
	...
	public CreditCardInformation getCreditCardInformation() {
		if (creditCardInformation != null && creditCardInformation.eIsProxy()) {
			...
			if (creditCardInformation != oldCreditCardInformation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.LEGAL_ENTITY__CREDIT_CARD_INFORMATION, oldCreditCardInformation, creditCardInformation));
			}
		}
	...
	public void setCreditCardInformation(CreditCardInformation newCreditCardInformation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.LEGAL_ENTITY__CREDIT_CARD_INFORMATION, oldCreditCardInformation, creditCardInformation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.LEGAL_ENTITY__PHONE:
				return getPhone();
			case ClassesPackage.LEGAL_ENTITY__EMAIL:
				return getEmail();
			case ClassesPackage.LEGAL_ENTITY__CREDIT_CARD_INFORMATION:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ClassesPackage.LEGAL_ENTITY___OPERATION1:
				Operation1();
				return null;
		}
