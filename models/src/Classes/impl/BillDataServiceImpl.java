...
public class BillDataServiceImpl extends MinimalEObjectImpl.Container implements BillDataService {
	...
	protected EClass eStaticClass() {
		return ClassesPackage.Literals.BILL_DATA_SERVICE;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ClassesPackage.BILL_DATA_SERVICE___GET__OBJECT:
				return get((Integer)arguments.get(0));
			case ClassesPackage.BILL_DATA_SERVICE___GET_ALL:
				return getAll();
			case ClassesPackage.BILL_DATA_SERVICE___COUNT:
				return count();
			case ClassesPackage.BILL_DATA_SERVICE___SET__OBJECT:
				set((Bill)arguments.get(0));
				return null;
			case ClassesPackage.BILL_DATA_SERVICE___SET_ALL__ELIST:
				setAll((EList<Bill>)arguments.get(0));
				return null;
			case ClassesPackage.BILL_DATA_SERVICE___DELETE__OBJECT:
				delete((Bill)arguments.get(0));
				return null;
			case ClassesPackage.BILL_DATA_SERVICE___EXIST__OBJECT:
