 ...
 * <ul>
 *   <li>{@link Classes.impl.BookingImpl#getId <em>Id</em>}</li>
 *   <li>{@link Classes.impl.BookingImpl#getStartDate <em>Start Date</em>}</li>
 *   <li>{@link Classes.impl.BookingImpl#getEndDate <em>End Date</em>}</li>
 *   <li>{@link Classes.impl.BookingImpl#getSpecialRequest <em>Special Request</em>}</li>
 *   <li>{@link Classes.impl.BookingImpl#getPrice <em>Price</em>}</li>
 *   <li>{@link Classes.impl.BookingImpl#getRoomStay <em>Room Stay</em>}</li>
 *   <li>{@link Classes.impl.BookingImpl#getRoomType <em>Room Type</em>}</li>
 *   <li>{@link Classes.impl.BookingImpl#getTravelInformation <em>Travel Information</em>}</li>
 *   <li>{@link Classes.impl.BookingImpl#getResponsible <em>Responsible</em>}</li>
 *   <li>{@link Classes.impl.BookingImpl#isCanceled <em>Is Canceled</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BookingImpl extends MinimalEObjectImpl.Container implements Booking {
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BOOKING__ID, oldId, id));
	}
	...
	public void setStartDate(Date newStartDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BOOKING__START_DATE, oldStartDate, startDate));
	}
	...
	public void setEndDate(Date newEndDate) {
		...
		endDate = newEndDate;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BOOKING__END_DATE, oldEndDate, endDate));
	}
	...
	public void setSpecialRequest(String newSpecialRequest) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BOOKING__SPECIAL_REQUEST, oldSpecialRequest, specialRequest));
	}
	...
	public void setPrice(double newPrice) {
		...
		price = newPrice;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BOOKING__PRICE, oldPrice, price));
	}
	...
	public RoomStay getRoomStay() {
		if (roomStay != null && roomStay.eIsProxy()) {
			...
			if (roomStay != oldRoomStay) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.BOOKING__ROOM_STAY, oldRoomStay, roomStay));
			}
		}
		return roomStay;
	}
	...
	public void setRoomStay(RoomStay newRoomStay) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BOOKING__ROOM_STAY, oldRoomStay, roomStay));
	}
	...
	public RoomType getRoomType() {
		if (roomType != null && roomType.eIsProxy()) {
			...
			if (roomType != oldRoomType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.BOOKING__ROOM_TYPE, oldRoomType, roomType));
			}
		}
		return roomType;
	}
	...
	public void setRoomType(RoomType newRoomType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BOOKING__ROOM_TYPE, oldRoomType, roomType));
	}
	...
	public TravelInformation getTravelInformation() {
		if (travelInformation != null && travelInformation.eIsProxy()) {
			...
			if (travelInformation != oldTravelInformation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.BOOKING__TRAVEL_INFORMATION, oldTravelInformation, travelInformation));
			}
		}
	...
	public void setTravelInformation(TravelInformation newTravelInformation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BOOKING__TRAVEL_INFORMATION, oldTravelInformation, travelInformation));
	}
	...
	public LegalEntity getResponsible() {
		if (responsible != null && responsible.eIsProxy()) {
			...
			if (responsible != oldResponsible) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.BOOKING__RESPONSIBLE, oldResponsible, responsible));
			}
		}
		return responsible;
	}
	...
	public void setResponsible(LegalEntity newResponsible) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BOOKING__RESPONSIBLE, oldResponsible, responsible));
	}
	...
	public void setIsCanceled(boolean newIsCanceled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.BOOKING__IS_CANCELED, oldIsCanceled, isCanceled));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.BOOKING__ID:
				return getId();
			case ClassesPackage.BOOKING__START_DATE:
				return getStartDate();
			case ClassesPackage.BOOKING__END_DATE:
				return getEndDate();
			case ClassesPackage.BOOKING__SPECIAL_REQUEST:
				return getSpecialRequest();
			case ClassesPackage.BOOKING__PRICE:
				return getPrice();
			case ClassesPackage.BOOKING__ROOM_STAY:
				if (resolve) return getRoomStay();
				return basicGetRoomStay();
			case ClassesPackage.BOOKING__ROOM_TYPE:
				if (resolve) return getRoomType();
				return basicGetRoomType();
			case ClassesPackage.BOOKING__TRAVEL_INFORMATION:
				if (resolve) return getTravelInformation();
				return basicGetTravelInformation();
			case ClassesPackage.BOOKING__RESPONSIBLE:
				if (resolve) return getResponsible();
				return basicGetResponsible();
			case ClassesPackage.BOOKING__IS_CANCELED:
				return isCanceled();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ClassesPackage.BOOKING___CHECK_IN:
				checkIn();
				return null;
			case ClassesPackage.BOOKING___CHECK_OUT:
				checkOut();
				return null;
			case ClassesPackage.BOOKING___REGISTER_TRAVEL_INFORMATION__TRAVELINFORMATION:
				registerTravelInformation((TravelInformation)arguments.get(0));
				return null;
			case ClassesPackage.BOOKING___UNREGISTER_TRAVEL_INFORMATION__TRAVELINFORMATION:
