 ...
 * <ul>
 *   <li>{@link Classes.impl.OrganizationImpl#getName <em>Name</em>}</li>
 *   <li>{@link Classes.impl.OrganizationImpl#getOrganizationNumber <em>Organization Number</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OrganizationImpl extends LegalEntityImpl implements Organization {
	...
	protected EClass eStaticClass() {
		return ClassesPackage.Literals.ORGANIZATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.ORGANIZATION__NAME, oldName, name));
	}
	...
	public void setOrganizationNumber(String newOrganizationNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.ORGANIZATION__ORGANIZATION_NUMBER, oldOrganizationNumber, organizationNumber));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.ORGANIZATION__NAME:
				return getName();
			case ClassesPackage.ORGANIZATION__ORGANIZATION_NUMBER:
