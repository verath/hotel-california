 ...
 * <ul>
 *   <li>{@link Classes.impl.PercentageDiscountImpl#getPercentage <em>Percentage</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PercentageDiscountImpl extends DiscountImpl implements PercentageDiscount {
	...
	protected EClass eStaticClass() {
		return ClassesPackage.Literals.PERCENTAGE_DISCOUNT;
	}
	...
	public void setPercentage(float newPercentage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.PERCENTAGE_DISCOUNT__PERCENTAGE, oldPercentage, percentage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.PERCENTAGE_DISCOUNT__PERCENTAGE:
