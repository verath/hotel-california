 ...
 * <ul>
 *   <li>{@link Classes.impl.TravelInformationImpl#getId <em>Id</em>}</li>
 *   <li>{@link Classes.impl.TravelInformationImpl#getTrackingId <em>Tracking Id</em>}</li>
 *   <li>{@link Classes.impl.TravelInformationImpl#getComment <em>Comment</em>}</li>
 *   <li>{@link Classes.impl.TravelInformationImpl#getPredecessor <em>Predecessor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TravelInformationImpl extends MinimalEObjectImpl.Container implements TravelInformation {
	...
	protected EClass eStaticClass() {
		return ClassesPackage.Literals.TRAVEL_INFORMATION;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.TRAVEL_INFORMATION__ID, oldId, id));
	}
	...
	public void setTrackingId(String newTrackingId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.TRAVEL_INFORMATION__TRACKING_ID, oldTrackingId, trackingId));
	}
	...
	public void setComment(String newComment) {
		...
		comment = newComment;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.TRAVEL_INFORMATION__COMMENT, oldComment, comment));
	}
	...
	public TravelInformation getPredecessor() {
		if (predecessor != null && predecessor.eIsProxy()) {
			...
			if (predecessor != oldPredecessor) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.TRAVEL_INFORMATION__PREDECESSOR, oldPredecessor, predecessor));
			}
		}
		return predecessor;
	}
	...
	public void setPredecessor(TravelInformation newPredecessor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.TRAVEL_INFORMATION__PREDECESSOR, oldPredecessor, predecessor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ClassesPackage.TRAVEL_INFORMATION__ID:
				return getId();
			case ClassesPackage.TRAVEL_INFORMATION__TRACKING_ID:
				return getTrackingId();
			case ClassesPackage.TRAVEL_INFORMATION__COMMENT:
				return getComment();
			case ClassesPackage.TRAVEL_INFORMATION__PREDECESSOR:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ClassesPackage.TRAVEL_INFORMATION___ADD_PREDECESSOR__TRAVELINFORMATION:
