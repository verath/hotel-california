 ...
 * <ul>
 *   <li>{@link tda593.hotel.california.impl.BookingBillImpl#getBooking <em>Booking</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BookingBillImpl extends BillImpl implements BookingBill {
	...
	protected EClass eStaticClass() {
		return CaliforniaPackage.Literals.BOOKING_BILL;
	}
		...
		if (booking != null && booking.eIsProxy()) {
			...
			if (booking != oldBooking) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CaliforniaPackage.BOOKING_BILL__BOOKING, oldBooking, booking));
			}
		}
		return booking;
	}
	...
	public void setBooking(Booking newBooking) {
		...
		booking = newBooking;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CaliforniaPackage.BOOKING_BILL__BOOKING, oldBooking, booking));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CaliforniaPackage.BOOKING_BILL__BOOKING:
