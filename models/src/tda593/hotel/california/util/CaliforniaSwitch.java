...
public class CaliforniaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CaliforniaPackage.BOOKING_DATA_SERVICE: {
			...
			case CaliforniaPackage.BOOKING_MANAGER: {
