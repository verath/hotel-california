 ...
 * <ul>
 *   <li>{@link tda593.hotel.california.discount.impl.DiscountManagerImplImpl#getDiscountDataService <em>Discount Data Service</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DiscountManagerImplImpl extends MinimalEObjectImpl.Container implements DiscountManagerImpl {
	...
	protected EClass eStaticClass() {
		return DiscountPackage.Literals.DISCOUNT_MANAGER_IMPL;
	}
		...
		if (discountDataService != null && discountDataService.eIsProxy()) {
			...
			if (discountDataService != oldDiscountDataService) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiscountPackage.DISCOUNT_MANAGER_IMPL__DISCOUNT_DATA_SERVICE, oldDiscountDataService, discountDataService));
			}
		}
	...
	public void setDiscountDataService(DiscountDataService newDiscountDataService) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiscountPackage.DISCOUNT_MANAGER_IMPL__DISCOUNT_DATA_SERVICE, oldDiscountDataService, discountDataService));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DiscountPackage.DISCOUNT_MANAGER_IMPL__DISCOUNT_DATA_SERVICE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DiscountPackage.DISCOUNT_MANAGER_IMPL___GET_DISCOUNT__INT:
