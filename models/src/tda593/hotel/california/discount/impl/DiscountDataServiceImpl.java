...
public class DiscountDataServiceImpl extends MinimalEObjectImpl.Container implements DiscountDataService {
	...
	protected EClass eStaticClass() {
		return DiscountPackage.Literals.DISCOUNT_DATA_SERVICE;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DiscountPackage.DISCOUNT_DATA_SERVICE___GET__OBJECT:
				return get((String)arguments.get(0));
			case DiscountPackage.DISCOUNT_DATA_SERVICE___GET_ALL:
				return getAll();
			case DiscountPackage.DISCOUNT_DATA_SERVICE___COUNT:
				return count();
			case DiscountPackage.DISCOUNT_DATA_SERVICE___SET__OBJECT:
				set((Discount)arguments.get(0));
				return null;
			case DiscountPackage.DISCOUNT_DATA_SERVICE___SET_ALL__ELIST:
				setAll((EList<Discount>)arguments.get(0));
				return null;
			case DiscountPackage.DISCOUNT_DATA_SERVICE___DELETE__OBJECT:
				delete((Discount)arguments.get(0));
				return null;
			case DiscountPackage.DISCOUNT_DATA_SERVICE___EXIST__OBJECT:
