...
public class BookingBillEntityImpl extends BillImpl implements BookingBillEntity {
	 ...
	 * @generated
	 */
	protected BookingBillEntityImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PersistencePackage.Literals.BOOKING_BILL_ENTITY;
	}
		...
		if (bookingEntity != null && bookingEntity.eIsProxy()) {
			...
			if (bookingEntity != oldBookingEntity) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PersistencePackage.BOOKING_BILL_ENTITY__BOOKING_ENTITY, oldBookingEntity, bookingEntity));
			}
		}
	...
	public void setBookingEntity(BookingEntity newBookingEntity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PersistencePackage.BOOKING_BILL_ENTITY__BOOKING_ENTITY, oldBookingEntity, bookingEntity));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PersistencePackage.BOOKING_BILL_ENTITY__BOOKING_ENTITY:
