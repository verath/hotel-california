...
public class DisabilityApprovalEntityImpl extends MinimalEObjectImpl.Container implements DisabilityApprovalEntity {
	 ...
	 * @generated
	 */
	protected DisabilityApprovalEntityImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return PersistencePackage.Literals.DISABILITY_APPROVAL_ENTITY;
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PersistencePackage.DISABILITY_APPROVAL_ENTITY__ID, oldId, id));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PersistencePackage.DISABILITY_APPROVAL_ENTITY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PersistencePackage.DISABILITY_APPROVAL_ENTITY__ID:
				return getId();
			case PersistencePackage.DISABILITY_APPROVAL_ENTITY__NAME:
				return getName();
		}
